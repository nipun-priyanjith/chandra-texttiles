...
// Functional component DashboardTab
        ...
        {/* DashboardTab structure */}
            <div className="container mx-auto">
                <div className="tab container mx-auto ">
                    {/* Tabs for Product, Orders, Users */}
                    <Tabs defaultIndex={0} className=" " >
                        {/* TabList for navigation */}
                        <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
                            {/* Product Tab */}
                            <Tab>
                                <button type="button" className="font-medium border-b-2 hover:shadow-purple-700  text-purple-500 rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]  px-5 py-1.5 text-center bg-[#605d5d12] ">
                            ...
                            {/* Orders Tab */}
                            <Tab>
                                <button type="button" className="font-medium border-b-2  bg-[#605d5d12] text-pink-500  hover:shadow-pink-700  rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]    px-5 py-1.5 text-center ">
                            ...
                            {/* Users Tab */}
                            <Tab>
                                <button type="button" className="font-medium border-b-2  bg-[#605d5d12] text-green-500 rounded-lg text-xl  hover:shadow-green-700 shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]   px-5 py-1.5 text-center ">
                                    <div className="flex gap-2 items-center">
  ...
  {/* Panel for displaying Product details */}
   ...
   {/* *********  */}
              ...
              {/* *********  */} 
                                    ...
                                    {/* allorder --> cartItems -- document part map */}
                                    {allorder.cartItems.map((item,index)=>{
                                        ...
                                        <tr className="bg-gray-50 border-b  dark:border-gray-700"  >
                                            ...
                                            <td className="px-6 py-4 text-black " >
                                            {item.size} {/* Access size from the current item */}
                                            </td>
...
export default DashboardTab  // Export the DashboardTab component
