...
// Accessing data from a React context using the useContext hook
    ...
    // Destructuring 'product' from context
        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-8 md:py-16 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                 {/* Mapping through product data */}
                    {product.slice(0, 8)// Displaying only the first 8 items
                        .map((item, index) => {
                            const { title, price, imageUrl, id } = item;// Destructuring properties from each product item
                            return (
