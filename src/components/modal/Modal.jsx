...
// placeOrder
// Modal Component for Placing Orders
export default function Modal({ name, address, pincode, phoneNumber,  // User details
     setName, setAddress, setPincode, setPhoneNumber,// Functions to update user details
      buyNow // Function to handle order placement
    }) {
